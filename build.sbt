...
organization := "com.chrisandjo"

version := "0.1.0-SNAPSHOT"

// description := "this project can foo a bar!"

homepage := Some(url("https://github.com/cwmyers/decimate"))
...
scmInfo := Some(
  ScmInfo(
    url("https://github.com/cwmyers/decimate"),
    "scm:git:https://github.com/cwmyers/decimate.git",
    Some("scm:git:git@github.com:cwmyers/decimate.git")
  )
)
...
/* entry point */
mainClass in (Compile, packageBin) := Some("com.chrisandjo.finance.budget.Budget")

mainClass in (Compile, run) := Some("com.chrisandjo.finance.budget.Budget")
...
pomExtra := (
  <developers>
    <developer>
      ...
      <email>chris@chrisandjo.com</email>
//    <url>http://chrisandjo.com</url>
    </developer>
  </developers>
)
...
/* assembly plugin */
mainClass in AssemblyKeys.assembly := Some("com.chrisandjo.decimate.Main")
